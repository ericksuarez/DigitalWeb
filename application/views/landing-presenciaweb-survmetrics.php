<?php echo $this->load->view('common/header_view');?>
    ...
    <div class="container">
      ...
      <div class="row">
      <div class="col-md-12">
    <h1 align="center">Solicita el <strong>complemento Survmetrics</strong> para tu paquete presencia web
            <br>
  ...
  <div class="col-md-6">
      <div class="panel panel-naranja">
         <div class="panel-body">
            <div class="row">
            <div class="col-md-6">
            <img src="images/logo-survmetrics.jpg" width="260" height="260" alt="Survmetrics logotipo" class="img-responsive" style="text-align:center"/>
            </div>
            <div class="col-md-6">
			<h3><strong>Encuestas <br>
Survmetrics</h3>
                </div>
                </div>
            </div>
    ...
    <div class="col-md-6">
			  ...
			  <input type="submit" name='envia' id='envia' class="btn btn-info pull-right" value='Cotizar encuesta'>
			</form>
