...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 align="center">Cotiza tu tienda en lína con <strong>PrestaShop</strong> y EstrategiasDigitales®
                <br>
                <img src="<?php echo base_url(); ?>images/puntos.gif" alt="EstrategiasDigitales®">
            </h1>
                ...
                <div class="col-md-6">
                    <div class="panel panel-naranja">
                        <div class="panel-body">
                            <h3 align="center">
                                <img src="<?php echo base_url(); ?>images/prestashop-insignia-estrategiasdigitales.png" alt="Insignia PrestaShop Bronce de EstrategiasDigitales®"><br>
                                <hr />
                                <strong>Tienda <em>online</em> PrestaShop</strong></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <form action='' method='POST'>
                        ...
                        <input type="submit" name='envia' id='envia' class="btn btn-info pull-right" value='Solicitar cotización'>
                    </form>
